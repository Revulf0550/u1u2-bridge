...
- **RS485-адаптеры Waveshare USB-TO-RS485 (B) на CH343G:** 3 из 4 подключены и зарегистрированы. Драйвер `cdc_acm`, имена `/dev/ttyACMx`, vendor:product `1a86:55d3`. Известные серийники:
  ...
  Четвёртый адаптер — в резерве, серийник неизвестен (физически воткнём + проверим `udevadm` когда понадобится).
