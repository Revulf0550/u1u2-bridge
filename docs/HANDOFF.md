...
> ⚠️ **ВНИМАНИЕ: ДОКУМЕНТ УСТАРЕЛ (на 2026-05-22).** Архитектурные секции и распиновка UART/GPIO здесь не отражают актуальное состояние проекта. По UART/GPIO на Orange Pi 5 Max — единственный источник истины: [`docs/wiring-opi5max.md`](wiring-opi5max.md) (UART7 через overlay `m1`, физ. пины 29/38). По актуальным урокам и инцидентам — `CLAUDE.md` в корне репо, раздел "Lessons & Incidents". Переписывание этого HANDOFF — задача отдельной сессии; до тех пор сверяйся с указанными выше документами.
