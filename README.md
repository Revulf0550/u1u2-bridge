...
Беспроводная замена 8-жильного кабеля между двумя устройствами FPV-наземки (У1 ↔ У2) через пару Orange Pi 5 + готовый Wi-Fi PtP мост TP-Link CPE710 + WireGuard поверх.

Полное описание — в [`docs/HANDOFF.md`](docs/HANDOFF.md). Главные инварианты для разработки — в [`CLAUDE.md`](CLAUDE.md).
